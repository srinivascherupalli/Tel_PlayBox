...
import fetchNumbersList from '@salesforce/apex/RemoveNumberNGUCController.fetchNumbers';
import fetchNumberFromCSV from '@salesforce/apex/RemoveNumberNGUCController.fetchNumberFromCSV';
import createOrder from '@salesforce/apex/RemoveNumberNGUCController.createOrderAndRemoveNumbers';
import submitOrder from '@salesforce/apex/RemoveNumberNGUCController.submitOrder';
...
import MACD_Remove_picklist_msg from '@salesforce/label/c.MACD_Remove_picklist_msg';
import MACD_Remove_selected_remove_msg from '@salesforce/label/c.MACD_Remove_selected_remove_msg';
import MACD_Remove_ui_header_msg from '@salesforce/label/c.MACD_Remove_ui_header_msg';
...
import MACD_Remove_confirm_removal_msg from '@salesforce/label/c.MACD_Remove_confirm_removal_msg';
import MACD_Remove_no_contigiuos_number_msg from '@salesforce/label/c.MACD_Remove_no_contigiuos_number_msg';

export default class RemoveNumberNGUC extends LightningElement {
    numberString = '';
    columns = [{
            label: 'Phone Number',
    ...
    label = {
        ...
        MACD_Remove_picklist_msg,
        MACD_Remove_selected_remove_msg,
        MACD_Remove_ui_header_msg,
        MACD_Remove_confirm_removal_msg,
        ...
        if (this.disableSubmit === true) {
            ...
            createOrder({
                ...
                .then(result => {
                    ...
                    this.showToastEvent('success', MACD_Remove_confirm_removal_msg);
    ...
    submitOrder(event) {
        ...
        submitOrder({
            ...
            .then(result => {
                this.showToastEvent('success', MACD_Remove_order_success_msg);
                window.location.href = this.oderRecordURL;
