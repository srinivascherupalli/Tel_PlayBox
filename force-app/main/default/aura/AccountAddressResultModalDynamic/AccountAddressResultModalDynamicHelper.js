({
    goToSearchAddress : function (component, event, helper) {
        console.log('AccountAddressResultModalDynamic   Helper  1 goToSearchAddress');
       console.log('AccountAddressResultModalDynamic   Controller');
    ...
    handleInputRecord : function (component, event, helper) {
       console.log('AccountAddressResultModalDynamic   Helper  2 handleInputRecord');
        ...
        if(params.searchType == 'UnStructuredAddressHandler' || params.searchType == 'StructuredAddressHandler'){
            ...
            if(params.searchedText == null || params.searchedText ==''){
                ...
                action.setCallback(this, function(response) {
                    ...
                    //component.set("v.loadingSpinner", false); // EDGE-177103 >> +
     ...
     * EDGE-122625
     * Method:dispMethod
     * Description: Method to display data
     * Author: Kalashree Borgaonkar
     ------------------------------------------------------*/
