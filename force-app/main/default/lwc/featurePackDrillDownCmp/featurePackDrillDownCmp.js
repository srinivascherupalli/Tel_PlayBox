...
import getFeaturePackDetails from '@salesforce/apex/FeaturePackDetailsHandler.getFeaturePackDetails';

export default class FeaturePackDrillDownCmp extends LightningElement {
    @track records =[];
    @api columns;
    @track error;
    @api chargeId;
    ...
    setDataTableRows()
    {
        getFeaturePackDetails({ chargeId: this.chargeId, statementNumber :this.statementNumber, accountNumber : this.accountNumber,handlerName:'FeaturePackHandler'
        })
        .then((result) => {
         //console.log('rsult fe',result);
          this.tableData = JSON.parse(result);
          
          this.error = undefined;
          this.loadSpinner = false;
          //this.records = this.tableData;
          console.log("old selected rows for feature pack:", this.oldSelectedRows);
    ...
    rowSelection (event){
        ...
        console.log('paginationMapInt in rowSelection',this.paginationMapInt);
    }
