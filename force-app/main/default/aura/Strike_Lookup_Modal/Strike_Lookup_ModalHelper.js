({
    ...
    navigateSiteAddressCustom: function(component, event, helper,inputSearchText) {
        /*var evt = $A.get("e.force:navigateToComponent");
        evt.setParams({
            componentDef : "c:SearchAddress",
            componentAttributes: {
                hiddenSiteName : component.find("SiteName").get("v.value") ,
                hiddenStatus : component.find("SiteStatusDynamic").get("v.value") ,
        ...
        */
        /*
        var myEvent = $A.get("e.c:strikeCreateAddress");
        myEvent.setParams({
        ...
        */
        ...
        appEvent.setParams({"ComponentAction" : 'CreateSiteModel_AddAddress' });
        appEvent.fire(); 
