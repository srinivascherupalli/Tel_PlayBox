...
import getRecurringChargeDetails from "@salesforce/apex/RecurringChargeDetailsHandler.getRecurringChargeDetails";

export default class RecurringChargeDrillDownComp extends LightningElement {
    ...
    setDataTableRows()
    {
      getRecurringChargeDetails({ chargeId: this.chargeId, statementNumber :this.statementNumber, accountNumber : this.accountNumber,handlerName:'RecurringChargeHandler'
        })
        .then((result) => {
         // console.log(result);
